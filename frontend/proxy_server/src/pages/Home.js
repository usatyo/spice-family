                                ...
                                <header className="App-header">
                                    ...
                                    <Stack p="40px" paddingRight="0" w="full" spacing={10} flexDirection="row">
                                        ...
                                        <Stack w="40%" h="full" paddingTop="40px" paddingRight="50px" paddingLeft="50px" >
                                            <Text color="gray.600" fontSize="xl" textAlign={"left"} fontWeight="bold" >白黒の世界に彩りを</Text>
                                            <Text color="blue.400" fontSize="6xl" textAlign={"left"} fontWeight="bold">プロ棋士サーバ</Text>
                                            <Stack w="90%">
                                                <Text color="gray.500" fontSize="md" textAlign={"left"} fontWeight="bold" paddingTop="30px">対局を通して囲碁のスキルを磨き、より高いレートを目指しましょう。プロ棋士サーバを使えば、対局時計を用意する必要も棋譜を記憶する必要もありません！</Text>
                                            </Stack>
                                            <HStack paddingTop="50px">
                                                <Link to="/prepare" >
                                                    <Button colorScheme="blue" variant="solid" w="150px" h="50px" borderRadius="25px" alignContent="left" shadow="lg" >
                                                        <HStack>
                                                            <TimeIcon w={7} h={7} color="white.500" />
                                                            <Text fontSize="lg" fontWeight="bold" colorScheme="blue">
                                                                対局準備</Text>
                                                        </HStack>
                                                    </Button>
                                                </Link>
                                            ...
                                            <HStack paddingTop="8px">
                                                <Link to="/record" >
                                                    <Button colorScheme="blue" variant="outline" w="230px" h="50px" borderRadius="25px" alignContent="left" shadow="lg" >
                                                        <HStack>
                                            ...
                                            <HStack paddingTop="10px">
                                                <Link to="/record" >
                                                    <Button colorScheme="grey" variant="outline" w="130px" h="34px" borderRadius="25px" onClick={logout} alignContent="left">
                                                        <HStack>
                                                            <Text fontSize="md">
                                                                ログアウト</Text>
                                                        </HStack>
                                        ...
                                        {/*右側の部分  */}
                                        <Stack style={{ marginTop: 90 }} bg={" white"} shadow="lg" roundedLeft="25px" w="60%" h="min">
                                            <HStack>
